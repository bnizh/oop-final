...
public class Buyer extends User {
    ...
    public Buyer(String username, String password, String email, String name, int rating, String mobileNumber, int voters, String image, int buyerID, boolean confirmed) {
            super(username, password, email,name,rating,mobileNumber,voters,image, buyerID,confirmed);
    }
